...
DROP VIEW IF EXISTS office_metrics;
DROP VIEW IF EXISTS dashboard_summary;

-- Recreate office_metrics view without SECURITY DEFINER
CREATE VIEW office_metrics AS
...
-- Recreate dashboard_summary view without SECURITY DEFINER
...
-- Recreate dashboard function with proper search_path
