-- Create partial unique index on google_place_id to prevent duplicates (only for non-null values)
CREATE UNIQUE INDEX idx_unique_google_place_id 
ON public.patient_sources (google_place_id, created_by) 
