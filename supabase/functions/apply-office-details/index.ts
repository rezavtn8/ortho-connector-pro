...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`apply-office-details: Applying ${updates.length} updates [${requestId}]`);
    ...
    console.log(`apply-office-details: Updated ${successCount}/${updates.length} offices [${requestId}]`);
