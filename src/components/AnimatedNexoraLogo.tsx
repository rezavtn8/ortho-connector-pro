      ...
      >
        <defs>
          <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#4CA89F" />
            <stop offset="100%" stopColor="#6BB7AD" />
          </linearGradient>
          <filter id="glow">
          ...
          <g>
            ...
            <path 
              ...
              style={{ 
                ...
                animation: animate ? 'pulse-dot 3s ease-in-out infinite' : 'none'
              }}
            />
            ...
            <path 
              ...
              style={{ 
                animation: animate ? 'pulse-dot 3s ease-in-out infinite 0.5s' : 'none'
              }}
            />
            ...
            <path 
              ...
              style={{ 
                animation: animate ? 'pulse-dot 3s ease-in-out infinite 1s' : 'none'
              }}
            />
            ...
            <path 
              ...
              style={{ 
                animation: animate ? 'pulse-dot 3s ease-in-out infinite 1.5s' : 'none'
              }}
            />
            ...
            <path 
              ...
              style={{ 
                animation: animate ? 'pulse-dot 3s ease-in-out infinite 2s' : 'none'
              }}
            />
            ...
            <path fill="#44827A" d="M1682.28,1321.78c-0.06,41.17,5.12,102.87,0,141.26c-0.41,3.09,1.22,3.85-3.3,3.27c-109.98-70.78-203.29-163.64-288.03-262.4l1.1-155.66C1480.36,1147.75,1571.9,1246.23,1682.28,1321.78z"/>
            <path fill="#43837B" d="M677.07,950.39c-0.15-0.19-2.87,0.41-4.47-1.59c-87.9-110.07-176.25-221.55-289.09-307.53c0.06-34.81-0.04-69.71,0-104.52l53.18,34.66c90.89,68.55,167.99,152.82,239.23,241.14L677.07,950.39z"/>
            <path fill="#6DB0A6" d="M830.52,1170.55c1.95,3.34,1.27,4.35-2.22,2.22c-46.72-64.57-94.72-128.31-149-186.81c0.29-0.66-0.32-1.72,0-2.22c2.69-4.26,11.79-7.73,8.9-17.79C741.09,1032.84,784.22,1099.35,830.52,1170.55z"/>
            <path fill="#6DAEA6" d="M1388.72,1012.66c-0.26,1.03-10.42,13.39-11.12,17.79c-45.43-58.43-97.72-112.76-137.88-175.69c-1.95-4.56-1.21-6.05,2.22-4.45c42.89,52.68,91.3,107.29,137.79,156.88C1382.29,1009.91,1384.62,1012.55,1388.72,1012.66z"/>
            
            {/* Final detail paths */}
            <path fill="#A1BEBA" d="M1241.94,850.31l-2.22,4.45l-35.56-51.15C1206.96,800.54,1239.19,846.93,1241.94,850.31z"/>
            <path fill="#97B8B5" d="M276.76,794.71l31.11,40.03c-10.31-9.13-20.81-18.72-30.16-28.85c-2.32-2.52-2.66-6.17-3.18-6.73L276.76,794.71z"/>
            <path fill="#A1BCB8" d="M830.52,1170.55c2.83,4.35,29.21,37.23,26.67,40.03c-12.54-9.77-19.71-25.12-28.89-37.81L830.52,1170.55z"/>
            <path fill="#B0C8C5" d="M1780.13,1215.03l-2.22,2.22c-7.13-8.24-18.7-16.09-24.46-26.67C1757.01,1187.41,1777.09,1212.06,1780.13,1215.03z"/>
          </g>
        </g>
      </svg>
    </div>
